...
export default function SectionCard(props: SectionCardProps) {
  return (
    <div className="flex cursor-pointer justify-between rounded-2xl border border-white border-opacity-40 bg-white bg-opacity-30 px-6 text-blue-950 transition duration-500 hover:bg-opacity-50 sm:justify-around sm:py-0">
